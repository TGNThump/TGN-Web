...
class SessionStorage extends AbstractStorage implements SessionInterface
{
    ...
    public function getByAccessToken(AccessTokenEntity $accessToken)
    {
        $result = Capsule::table('oauth_sessions')
                            ->select(['oauth_sessions.id', 'oauth_sessions.owner_type', 'oauth_sessions.owner_id', 'oauth_sessions.consumer_id', 'oauth_sessions.redirect_uri'])
    ...
    public function getScopes(SessionEntity $session)
    {
        $result = Capsule::table('oauth_sessions')
                            ...
                            ->join('scopes', 'scopes.id', '=', 'oauth_session_scopes.scope')
